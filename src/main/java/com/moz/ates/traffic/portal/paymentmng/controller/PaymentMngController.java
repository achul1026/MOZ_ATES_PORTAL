package com.moz.ates.traffic.portal.paymentmng.controller;
...
public class PaymentMngController {
    ...
    public String paymentInfo(Model model){
        ...
        return "views/paymentmng/paymentCnfrm";
    }
    ...
    public String paymentInfoRegister(Model model,@RequestParam Map<String,Object>paramMap,
    	...
    	//return default page
    	String returnPage = "views/paymentmng/paymentInfoRegister";
    	...
    	if(paymentInfo == null) {
    		redirectAttributes.addFlashAttribute("resultMsg","payment information was not found. Please check your license ID and name.");
    ...
    public String paymentInfoCmplt(Model model,@RequestParam Map<String,Object>paramMap,
    	...
    	//return default page
    	String returnPage = "redirect:/paymentmng/paymentCnfrm";
    	...
    	try {
    		...
    		redirectAttributes.addFlashAttribute("resultMsg","The payment information registration was failed.");
    	}
